                                ...
                                <?php $__currentLoopData = json_decode($verification_form); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php elseif($element->type == 'file'): ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="<?php echo e($element->type); ?>" name="element_<?php echo e($key); ?>" id="file-2" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" required/>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/seller/verify_form.blade.php ENDPATH**/ ?>