                                                        ...
                                                        <?php $__currentLoopData = json_decode($shop->sliders); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sliders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="col-md-6">
                                                                <div class="img-upload-preview">
                                                                    <img src="<?php echo e(asset($sliders)); ?>" alt="" class="img-fluid">
                        ...
                        <form class="" action="<?php echo e(route('shops.update', $shop->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><i class="line-height-1_8 size-24 mr-2 fa fa-instagram bg-instagram c-white text-center"></i><?php echo e(__('Instagram')); ?> </label>
                                        </div>
                                        <div class="col-md-10">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/seller/shop.blade.php ENDPATH**/ ?>