                                                ...
                                                <?php if(\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Instamojo">
                                                            ...
                                                            <span>
                                                                <img src="<?php echo e(asset('frontend/images/icons/cards/instamojo.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Razorpay">
                                                            ...
                                                            <span>
                                                                <img src="<?php echo e(asset('frontend/images/icons/cards/rozarpay.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'paystack')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paystack">
                                                            ...
                                                            <span>
                                                                <img src="<?php echo e(asset('frontend/images/icons/cards/paystack.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/payment_select.blade.php ENDPATH**/ ?>