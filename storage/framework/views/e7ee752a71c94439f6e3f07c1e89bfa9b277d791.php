...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/paypal.png')); ?>" height="30">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/stripe.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/sslcommerz.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/instamojo.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/rozarpay.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/paystack.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img class="pull-left" src="<?php echo e(asset('frontend/images/icons/cards/cod.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/business_settings/activation.blade.php ENDPATH**/ ?>