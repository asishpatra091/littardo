                        ...
                        <form class="" action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-control mb-3 c-pointer" data-toggle="modal" data-target="#categorySelectModal" id="product_category"><?php echo e(__('Select a category')); ?></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Product Brand')); ?> <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="mb-3">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Purchase Price')); ?> <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="<?php echo e(__('Purchase Price')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Tax')); ?></label>
                                        </div>
                                        <div class="col-8">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="tax" placeholder="<?php echo e(__('Tax')); ?>" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="discount" placeholder="<?php echo e(__('Discount')); ?>" required>
                                        </div>
                                        <div class="col-4 col-md-2">
                                            <div class="mb-3">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Local Pickup')); ?></label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="local_pickup_shipping_cost" placeholder="<?php echo e(__('Local Pickup Cost')); ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="switch" style="margin-top:5px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Flat Rate')); ?></label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="flat_shipping_cost" placeholder="<?php echo e(__('Flat Rate Cost')); ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="switch" style="margin-top:5px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Free Shipping')); ?></label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="free_shipping_cost" value="0" disabled placeholder="<?php echo e(__('Flat Rate Cost')); ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="switch" style="margin-top:5px;">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/seller/product_upload.blade.php ENDPATH**/ ?>