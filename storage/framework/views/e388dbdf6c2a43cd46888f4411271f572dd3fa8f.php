                    ...
                    <div class="text-center text-md-right">
                        <ul class="inline-links">
                            ...
                            <?php if(\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1): ?>
                                <li>
                                    <img src="<?php echo e(asset('frontend/images/icons/cards/instamojo.png')); ?>" height="20">
                                </li>
                            <?php endif; ?>
                            <?php if(\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1): ?>
                                <li>
                                    <img src="<?php echo e(asset('frontend/images/icons/cards/rozarpay.png')); ?>" height="20">
                                </li>
                            <?php endif; ?>
                            <?php if(\App\BusinessSetting::where('type', 'paystack')->first()->value == 1): ?>
                                <li>
                                    <img src="<?php echo e(asset('frontend/images/icons/cards/paystack.png')); ?>" height="20">
                                </li>
                            <?php endif; ?>
...
<?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/inc/footer.blade.php ENDPATH**/ ?>