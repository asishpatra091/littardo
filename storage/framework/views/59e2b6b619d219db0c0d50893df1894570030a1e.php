                        ...
                        <form class="" action="<?php echo e(route('seller.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Instamojo')); ?></label>
                                        </div>
                                        <div class="col-md-10">
                                            <label class="switch mb-3">
                                                <input value="1" name="instamojo_status" type="checkbox" <?php if(Auth::user()->seller->instamojo_status == 1): ?> checked <?php endif; ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('Instamojo Api Key')); ?>" value="<?php echo e(Auth::user()->seller->instamojo_api_key); ?>" name="instamojo_api_key">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('Instamojo Auth Token')); ?>" value="<?php echo e(Auth::user()->seller->instamojo_token); ?>" name="instamojo_token">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('RazorPay')); ?></label>
                                        </div>
                                        <div class="col-md-10">
                                            <label class="switch mb-3">
                                                <input value="1" name="razorpay_status" type="checkbox" <?php if(Auth::user()->seller->razorpay_status == 1): ?> checked <?php endif; ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Razor Key')); ?></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('Razor Key')); ?>" value="<?php echo e(Auth::user()->seller->razorpay_api_key); ?>" name="razorpay_api_key">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Razor Secret')); ?></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('Razor Secret')); ?>" value="<?php echo e(Auth::user()->seller->razorpay_secret); ?>" name="razorpay_secret">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('PayStack')); ?></label>
                                        </div>
                                        <div class="col-md-10">
                                            <label class="switch mb-3">
                                                <input value="1" name="paystack_status" type="checkbox" <?php if(Auth::user()->seller->paystack_status == 1): ?> checked <?php endif; ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('PayStack Public Key')); ?>" value="<?php echo e(Auth::user()->seller->paystack_public_key); ?>" name="paystack_public_key">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="<?php echo e(__('PayStack Secret Key')); ?>" value="<?php echo e(Auth::user()->seller->paystack_secret_key); ?>" name="paystack_secret_key">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/littardoemporium/public_html/shop/resources/views/frontend/seller/profile.blade.php ENDPATH**/ ?>